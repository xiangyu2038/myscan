...
Core.menu={
        ...
        },
    {
        ...
        data: [[{
            text: "默认",
            func: function() {
                $(this).attr("style",'background:url(admin/webdesktop/images/background.jpg) repeat right bottom transparent;');
            }
        }, {
            text: "梦幻绿",
            func: function() {
                $(this).attr("style",'background:url(admin/webdesktop/images/background0.jpg) repeat right bottom transparent;');
            }       
        }]]
    }],[
        {
