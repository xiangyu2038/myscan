define({ "api": [
  ...
  },
  {
    ...
    "filename": "app/Http/Controllers/Api/PDA/PDAController - 副本.php",
    "groupTitle": "pda模块"
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "成功示例:",
          "content": "{\"code\":0,\"msg\":\"ok\",\"data\":{\"id\":1,\"stock_in_sn\":\"123\",\"stock_sn_s\":[\"4-SA01Z01C01\",\"4SA01Z01C02\"],\"has_box_num\":8,\"detail\":[{\"stock_sn\":\"4-SA01Z01C01\",\"stock_box\":[]},{\"stock_sn\":\"4SA01Z01C02\",\"stock_box\":[]}]}}",
          "type": "json"
        }
      ]
    },
