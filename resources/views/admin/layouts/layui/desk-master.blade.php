...
<head>
    ...
    <title>@yield('title')gtt</title>
    <link rel="stylesheet" type="text/css" href="{{asset('admin/layui/static/admin/layui/css/layui.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('admin/layui/static/admin/css/admin.css')}}" />
</head>
...
<script src="{{asset('admin/layui/static/admin/layui/layui.js')}}" type="text/javascript" charset="utf-8"></script>
<script src="{{asset('admin/layui/static/admin/js/common.js')}}" type="text/javascript" charset="utf-8"></script>
<script>
